Bfc_st BFC[] = {
  ...
  {"emcY2" ,"","","emc_T,tpc_T,db,emcSim,PreEcl,epc","",""
  ...
  {"FttDat","","","","StFttDigiMaker","StFttDigiMaker", "sTGC Raw hit maker",kFALSE},
  ...
  {"Flow" ,"","","," ,"","","WARNING *** Option is OBSOLETE ***",kFALSE},
  {"FlowTag" ,"","","" ,"","","WARNING *** Option is OBSOLETE ***",kFALSE},
  {"FlowAnalysis","","","" ,"","WARNING *** Option is OBSOLETE ***","",kFALSE},
